...
2026-05-24 as **P2** of `docs/design/2026-05-24_claude_books_learnings.md` (modeled on the
sibling `claude-books/handbook/PEDAGOGY.md`, re-grounded for interview-prep).
...
transfer-over-retention context — *not* the claude-books set.)
